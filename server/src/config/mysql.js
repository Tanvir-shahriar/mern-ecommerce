...
const tables = ['users', 'brands', 'categories', 'products', 'coupons', 'carts', 'orders', 'currency_settings', 'payment_settings', 'galleries', 'hero_settings', 'search_logs', 'contact_messages'];
